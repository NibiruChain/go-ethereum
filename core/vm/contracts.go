...
func RunPrecompiledContract(p PrecompiledContract, input []byte, suppliedGas uint64, logger *tracing.Hooks, firehoseContext *firehose.Context) (ret []byte, remainingGas uint64, err error) {
