...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	...
	for {
		...
		if !contract.UseGas(cost, in.evm.Config.Tracer, tracing.GasChangeIgnored, firehose.IgnoredGasChangeReason) {
		...
		if operation.dynamicGas != nil {
			...
			if !contract.UseGas(dynamicCost, in.evm.Config.Tracer, tracing.GasChangeIgnored, firehose.IgnoredGasChangeReason) {
				return nil, ErrOutOfGas
			}
