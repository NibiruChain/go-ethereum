...
func filledStateDB() *StateDB {
	...
	state.SetBalance(addr, uint256.NewInt(42), tracing.BalanceChangeUnspecified, firehose.NoOpContext, firehose.IgnoredBalanceChangeReason) // Change the account trie
