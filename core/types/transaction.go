...
func (d *firehoseTxData) encode(buffer *bytes.Buffer) error {
	panic(txDataUpdatedMessage)
}

func (d *firehoseTxData) decode(i []byte) error {
	panic(txDataUpdatedMessage)
}
...
func (*firehoseTxData) blobGas() uint64           { panic(txDataUpdatedMessage) }
func (*firehoseTxData) blobGasFeeCap() *big.Int   { panic(txDataUpdatedMessage) }
func (*firehoseTxData) blobHashes() []common.Hash { panic(txDataUpdatedMessage) }
