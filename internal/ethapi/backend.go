...
type Backend interface {
	...
	GetEVM(ctx context.Context, msg *core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config, blockCtx *vm.BlockContext, firehoseContext *firehose.Context) (*vm.EVM, func() error)
